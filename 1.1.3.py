...
# Function to extract actual URL from Google News redirect link
def extract_actual_url(google_news_url):
    ...
    if 'url' in query_params:
        ...
        return actual_url
    return google_news_url  # Return original URL if no redirection URL is found


# Function to get titles and actual URLs
def get_titles(search, country_code):
    ...
    try:
        ...
        for item in newsitem:
            ...
            actual_url = extract_actual_url(item.link)

            story = {
                'title': item.title,
                'link': actual_url,  # Store the actual URL instead of Google News redirect
                'publisher': publisher,
                'published': published,
                'keyword': search,
...
# Updated keywords list in Portuguese
keywords = [
